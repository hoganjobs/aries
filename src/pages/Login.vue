                ...
                .then(function(res) {
                    if (res.data.login) {
                        ...
                        if (
                            ...
                            JSON.stringify(userInfo.bind_account) != "{}"
                        ) {
                            ...
                            if (JSON.stringify(plat) != "{}") {
                                ...
                                for (
                                    let i = 0;
                                    i < media_platform.length;
                                    i++
                                ) {
                                    if (
                                        bind_account[
                                            media_platform[i].app_name
                                        ] &&
                                        JSON.stringify(
                                            bind_account[
                                                media_platform[i].app_name
